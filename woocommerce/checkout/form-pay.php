	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'blohm' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'blohm' ); ?></th>
			</tr>
		</thead>
		<tbody>
